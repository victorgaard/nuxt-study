...
const filteredProducts = computed(() =>
  filterProducts({ productsArray: products.value, searchTerm: search.value }),
);
...
<template>
  <div v-if="error">
    There was an issue fetching the products.
  ...
  <div v-else class="flex flex-col gap-6">
    ...
    <div
      v-else
      class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-12"
    >
      <ProductCardWrapper
      ...
      >
        ...
        <ProductCardContent>
          <ProductCardFlavors>
            <LabelButton
              v-for="flavor in product.flavor_profile"
              :key="flavor"
