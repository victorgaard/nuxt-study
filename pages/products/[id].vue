...
<template>
  <div v-if="error">
    There was an issue fetching the product.
        ...
        <div class="flex flex-col gap-8">
          <div class="flex flex-col gap-1.5">
            <p class="text-3xl font-medium">
              {{ name }} <span class="text-slate-400">•</span>
              {{ formatWeight(weight) }}
            </p>
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <div class="flex gap-2">
              <p
                v-for="flavor in flavor_profile"
                :key="flavor"
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <div class="flex items-center gap-2">
              <CoffeeBeanIcon
                v-for="(_, index) in Array.from(Array(5).keys())"
                :key="index"
                :class="{
                  'fill-orange-800': index + 1 <= roast_level,
                  'fill-slate-700': index + 1 > roast_level,
                }"
              />
            </div>
          </div>
